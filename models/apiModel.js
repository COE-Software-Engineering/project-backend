...
export async function getAllAnnouncementsFromDB() {
  let query =
    "SELECT Announcement.title, Announcement.content, CONCAT(Lecturer.last_name, ' ', Lecturer.other_names) as lecturer_name FROM Announcement LEFT JOIN Lecturer ON Announcement.poster_id = Lecturer.staff_id";
