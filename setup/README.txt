// For Database set up
* copy the text in 'db_setup_queries.txt
* paste in psql command line
...
* create a .env file and place the contents of 'env_vars.txt' inside
* fill the missing database details with your details